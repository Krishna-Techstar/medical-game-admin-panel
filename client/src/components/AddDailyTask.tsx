...
export function AddDailyTask({ selectedClass, classes = [], students = [], onBack, onTaskCreated, accessToken }: AddDailyTaskProps) {
  ...
  const activeClass = selectedClass || classes.find((c: any) => c.id === selectedClassId) || null;
